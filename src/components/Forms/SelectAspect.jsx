    ...
    return (
        <div className="space-y-3">
            ...
            <div className="relative flex items-center">
                <img src="/assets/Aspect.png" alt="Icon" className="absolute left-2 h-7 w-4" />
                <select
            ...
            <div className="relative flex items-center">
                ...
                >
                    ...
                    {(subAspects[aspectId] || []).map((subAspect, index) => (
                        <option key={index} value={subAspect.id}>{subAspect.name}</option>
                    ))}
                </select>
            </div>
            ...
            <div className="relative flex items-center">
                ...
                >
                    ...
                    {categories[subAspectId] && categories[subAspectId].length > 0 ? (
                        categories[subAspectId].map((category, index) => (
